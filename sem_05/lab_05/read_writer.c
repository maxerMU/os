...
struct sembuf start_write[5] = {{WAIT_WRITER, v, IPC_CREAT | SEM_UNDO}, // инкремент счётчика ждущих писателей
                                {BIN_SEM, p, IPC_CREAT | SEM_UNDO}, // монопольный доступ
                                {ACT_READER, 0, IPC_CREAT | SEM_UNDO},  // проверка, есть ли активные читатели
...
struct sembuf stop_write[2] = {{ACT_WRITER, v, IPC_CREAT | SEM_UNDO},
                               {BIN_SEM, v, IPC_CREAT | SEM_UNDO}};
