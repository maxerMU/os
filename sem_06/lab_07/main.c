...
{
	printk(KERN_DEBUG "myfs: make inode\n");
...
{
	printk(KERN_DEBUG "myfs: put super\n");
}
...
{
	printk(KERN_DEBUG "myfs: kill sb\n");
	kill_anon_super(sb);
}
